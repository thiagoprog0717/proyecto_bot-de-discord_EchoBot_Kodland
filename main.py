...
async def start(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5a764.jpg"))
...
async def PEP(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5aae0.png"))
    await asyncio.to_thread(speak, texto)
...
async def CELC(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5a7fc.png"))
    await asyncio.to_thread(speak, texto)
...
async def CPCPDEP(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5aec2.png"))
    await asyncio.to_thread(speak, texto)
...
async def CPCALDPSECC(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5b2e0.jpg"))
    await asyncio.to_thread(speak, texto)
...
async def DCCYCG(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b5b67e.png"))
    await asyncio.to_thread(speak, texto)
...
async def QHDC(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b608f7.png"))
    await asyncio.to_thread(speak, texto)
...
async def EATDD(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b61079.png"))
    await asyncio.to_thread(speak, texto)
...
async def QSLGEI(ctx):
    ...
    await ctx.send(texto, file=discord.File("image_b613dc.jpg"))
    await asyncio.to_thread(speak, texto)
...
async def CER(ctx):
    ...
    # Imagen de Energías renovables VS no renovables
    await ctx.send(texto, file=discord.File("image_b68fdf.png"))
    await asyncio.to_thread(speak, texto)
...
async def QPSNHA(ctx):
    ...
    # Imagen sobre los efectos de si actuamos vs si no actuamos
    await ctx.send(texto, file=discord.File("image_b68f9f.jpg"))
    await asyncio.to_thread(speak, texto)
...
bot.run("aqui tu token de discord")